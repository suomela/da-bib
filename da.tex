...
\begin{itemize}
    ...
    \item Network decompositions \cite{awerbuch-goldberg-etal-1989-network-decomposition-and}, MPX \cite{miller-peng-xu-2013-parallel-graph-decompositions-using}, Rozhon--Ghaffari \cite{rozhon-ghaffari-2020-polylogarithmic-time-deterministic}
\end{itemize}
